...
```
브라우저(`web-year-playhead` 미리보기): 전체 범위 재생이 20초, 1945→2010은 3초 안. `/?from=2010&to=2014`에서 재생 → 빨간 선이 2010 칸 왼쪽에서 2014 칸 오른쪽까지 이동, 위 연도가 2010→2014, 지도 점이 해마다 늘고, 끝에서 선이 사라지며 지도가 전체 범위로. 일시정지 → 선이 멈추고 재개 가능. 손잡이 끌기 → 선 사라짐.
