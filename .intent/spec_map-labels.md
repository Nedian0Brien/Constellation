...
- 영역 원 45개가 겹쳐 그려져도 GPU 비용은 늘지 않았다(프로덕션 1440×950 DPR 2, 빽빽한 자리, 휠 한 단계 GPUTask): 3200% 0.60ms·6400% 0.62ms·25600% 0.71ms — 텍스처 한 장이던 때의 0.71ms와 같다. RunTask는 8.75·6.24·5.90ms.
